...
TEST_F(Clustering_Metrics, DaviesBouldinIndexScaling) {
    ...
    for(int i=0; i<10; ++i) for(int d=0; d<5; ++d) samplesA.at<float>(i, d) = 0.0f;
    for(int i=10; i<20; ++i) for(int d=0; d<5; ++d) samplesA.at<float>(i, d) = 1.0f;
    ...
    for(int i=0; i<10; ++i) for(int d=0; d<5; ++d) samplesB.at<float>(i, d) = 0.45f;
    for(int i=10; i<20; ++i) for(int d=0; d<5; ++d) samplesB.at<float>(i, d) = 0.55f;
