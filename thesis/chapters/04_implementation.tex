...
\begin{lstlisting}[caption={2D thread indexing and boundary check in \texttt{strided\_data\_\allowbreak preprocessor.cu}.}, label={fig:thread_idx_code}]
...
Code Snippet~\ref{fig:quantum_sim_code} shows the inner loop of the \texttt{QuantumEngine} assignment kernel, showing these optimizations in action.
...
\begin{lstlisting}[caption={Two-tier local-to-global atomic reduction in \texttt{base\_kmeans\_\allowbreak engine.cu}.}, label={fig:atomic_reduction_code}]
