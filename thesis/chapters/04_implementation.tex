...
A thread block size of $16 \times 16$ ($256$ threads per block) is selected. In the NVIDIA Blackwell architecture, this block size maximizes Streaming Multiprocessor (SM) occupancy \cite{CudaGuide}. It provides a balanced distribution of registers per thread, allowing the hardware scheduler to hide memory latency by keeping warps highly active without running out of registers \cite{CudaGuide, cook2012cuda}.
...
\label{tab:hyperparameters}
    ...
    \hline
        ...
        Execution & \texttt{PROCESS\_WIDTH} & 640 px & Internal resolution to maximize kernel throughput. \\ \hline
