...
\begin{lstlisting}[float=htbp, caption={Quantum-inspired phase mapping and fast SFU cosine evaluation in \texttt{quantum\_engine.cu} (lines 68-82).}, label={fig:quantum_sim_code}]
...
\begin{lstlisting}[float=htbp, caption={Two-tier local-to-global atomic reduction in \texttt{base\_kmeans\_\allowbreak engine.cu} (lines 79-98).}, label={fig:atomic_reduction_code}]
