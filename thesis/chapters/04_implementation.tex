...
The system supports two initialization strategies: Random and K-Means++ (selectable at runtime via the benchmarking configuration dashboard detailed in Section~\ref{subsect:ui_telemetry}).
