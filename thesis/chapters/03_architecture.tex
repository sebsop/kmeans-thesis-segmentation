...
To prevent coupling between the user interface and high-performance computation, specific software design patterns are used to separate the GUI from the underlying mathematical engines. This structural isolation ensures the system remains modular, extensible, and easy to maintain \cite{gamma1995design}.

\subsection{Design Patterns and Software Architecture}

\subsubsection{Creational and Structural Design Patterns}
...
\subsubsection{Behavioral and Concurrency Design Patterns}
...
\subsubsection{The Normalized 5D Manifold}\label{subsect:normalized_manifold}
...
\subsubsection{Phase Mapping for the Quantum Engine}
...
\subsubsection{Strided Sampling for Dimensionality Reduction}
...
\subsubsection{ClusteringManager (The Orchestrator)}
...
\subsubsection{CudaAssignmentContext (The Resource Container)}
...
\subsubsection{Engine Hierarchy and Factory}
...
\subsubsection{StridedDataPreprocessor}
