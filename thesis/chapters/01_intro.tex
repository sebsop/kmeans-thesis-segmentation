...
This thesis develops and validates a high-throughput, GPU-accelerated C++ and CUDA (Compute Unified Device Architecture) framework for real-time 5D image segmentation. The specific objectives are to:
\begin{itemize}
