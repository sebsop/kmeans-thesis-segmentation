...
Image segmentation is a fundamental computer vision task that partitions an image into meaningful, uniformly connected regions \cite{gonzalez2009digital}. It serves as an essential preprocessing step for high-level computer vision applications, such as lane-tracking in autonomous vehicles \cite{janai2020computer}, object detection \cite{redmon2016you}, and medical imaging overlays \cite{pham2000current}. While simple color-based segmentation is common, modern real-time applications require spatial consistency. To achieve this, each pixel is mapped to a 5D feature manifold:
\begin{equation}
