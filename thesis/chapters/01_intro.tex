...
\begin{itemize}
    ...
    \item \textbf{Maximize VRAM (Video Random Access Memory) Memory Efficiency:} Design custom CUDA kernels that utilize high-speed on-chip shared memory atomics to reduce global memory contention during centroid updates \cite{CudaGuide}.
